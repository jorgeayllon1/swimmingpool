...
{
public:
    Svgfile(std::string _filename = "output.svg", int _width = 1800, int _height = 900);
    ~Svgfile();

    void addDisk(double x, double y, double r, std::string color = defcol);
    void addRect(double x1, double y1, double w, double h, std::string color);
    ...
    void addRectCourbe(double x1, double y1, double w, double h, std::string color);
